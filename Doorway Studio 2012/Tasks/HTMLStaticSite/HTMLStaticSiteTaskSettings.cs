...
{
    [Serializable, XmlRoot(ElementName = "HTMLStaticSiteTaskSettings")]
    public class HTMLStaticSiteTaskSettings : TaskSettings
    {
        public HTMLStaticSiteTaskSettings()
        {
            this.PageNamesGeneralExtension = ".html";
            this.PageNamesGeneralSeparator = "-";
            this.PageNamesMainPageName = "index";
            this.PageNamesMainPageContinues = false;
            this.PageNamesMainPageContinuesName = "[N]/index";
            this.PageNamesMainPageContinuesKeywordsPerPage = 10;
            this.PageNamesRegularPages = PageNameType.Keyword;
            this.PageNamesRegularPagesName = "[Name]";
            this.PageNamesStaticPages = PageNameType.Keyword;
            this.PageNamesStaticPagesName = "[Name]";
            this.PageNamesCategoryPages = PageNameType.Keyword;
            this.PageNamesCategoryPagesName = "[CName]/index";
            this.PageNamesCategoryPagesContinues = false;
            this.PageNamesCategoryPagesContinuesName = "[CName]/index-[N]";
        ...
        public override string Name { get { return "HTMLStaticSiteTaskSettings"; } }
        
        #region Page Names

        /// <summary>
        /// Gets or sets page extension
        /// </summary>
        [XmlElement(ElementName = "PageNamesGeneralExtension")]
        public string PageNamesGeneralExtension { get; set; }

        /// <summary>
        /// Gets or sets page separator
        /// </summary>
        [XmlElement(ElementName = "PageNamesGeneralSeparator")]
        public string PageNamesGeneralSeparator { get; set; }

        /// <summary>
        /// Gets or sets main page name
        /// </summary>
        [XmlElement(ElementName = "PageNamesMainPageName")]
        public string PageNamesMainPageName { get; set; }
        ...
        /// <summary>
        /// Gets or sets regular page names type
        /// </summary>
        [XmlElement(ElementName = "PageNamesRegularPages")]
        public PageNameType PageNamesRegularPages { get; set; }
        ...
        /// <summary>
        /// Gets or sets static page names type
        /// </summary>
        [XmlElement(ElementName = "PageNamesStaticPages")]
        public PageNameType PageNamesStaticPages { get; set; }
        ...
        /// <summary>
        /// Gets or sets categories page names type
        /// </summary>
        [XmlElement(ElementName = "PageNamesCategoryPages")]
        public PageNameType PageNamesCategoryPages { get; set; }
