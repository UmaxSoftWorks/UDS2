...
{
    public class CategoryContinueLinkComplexToken : ExtendableToken, IComplexToken, ITokensRegexCompatible, ITokenTemplateEditorCompatible
    {
        public override bool Bold { get { return true; } }

        public override Color Color { get { return Color.Red; } }

        public override string Name { get { return "[CategoryContinueLink]"; } }

        public override string[] Tokens { get { return new string[] { "[CategoryContinueLink(:X)]" }; } }
        ...
        public string[] RegexTokens { get { return new string[] { @"(\[|{)CategoryContinueLink([a-zA-Z0-9 ]+)*(\]|})" }; } }
        ...
        public string[] Token
        {
            get
            {
                return new string[]
                           {
                               "[CategoryContinueLink:Random]", "[CategoryContinueLink:Next]",
                               "[CategoryContinueLink:Prev]", "[CategoryContinueLink:Last]",
                               "[CategoryContinueLink:Prev:Circle]", "[CategoryContinueLink:Last:Circle]"
                           };
            }
        }
        ...
        protected virtual IPage ProcessExtensions(IPage Page, IContentContainer ContentContainer, List<string> Extensions)
        {
            ...
            List<IPage> pages = (from IPage item in ContentContainer.Pages
                                 where item.Type == FileType.Category && item.Category == Page.Category
