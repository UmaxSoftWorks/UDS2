...
{
    public class StaticBlockComplexToken : MinMaxExtendableToken, IComplexToken, ITokensRegexCompatible, ITokenTemplateEditorCompatible
    {
        public override bool Bold { get { return true; } }

        public override Color Color { get { return Color.Red; } }

        public override string Name { get { return "[StaticBlock]"; } }

        public override string[] Tokens { get { return new string[] { "[StaticBlock:X:X]", "[/StaticBlock]" }; } }
        ...
        protected string[] RegexTokensStart { get { return new string[] { @"(\[|{)StaticBlock:[0-9]+:[0-9]+(\]|})" }; } }
        protected string[] RegexTokensEnd { get { return new string[] { @"(\[|{)/StaticBlock(\]|})" }; } }

        public string[] Token
        {
            get
            {
                string begin = "[StaticBlock:5:10] [StaticLink] ";
                string end = " [/StaticBlock:5:10]";
                return new string[]
                           {
                               begin + "[StaticKeyword]" + end,
                               begin + "[StaticKeyword:Big]" + end,
                               begin + "[StaticKeyword:All]" + end,
                               begin + "[StaticKeyword:Com]" + end,
                               begin + "[StaticKeyword:BigAllWords]" + end,
                               begin + "[StaticKeyword:BigBigWords]" + end
                           };
            }
        }
        ...
        public string[] RegexTokenTokens { get { return new string[] { @"(\[|{)StaticKeyword([a-zA-Z0-9 ]+)*(\]|})" }; } }

        public string[] TokenExtensions { get { return new string[] { "Big", "All", "Com", "BigAllWords", "BigBigWords" }; } }

        public string[] RegexLinkTokens { get { return new string[] { @"(\[|{)StaticLink(\]|})" }; } }
