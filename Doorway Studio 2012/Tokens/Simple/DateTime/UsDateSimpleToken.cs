...
{
    public class UsDateSimpleToken : ExtendableToken, ISimpleToken, ITokensRegexCompatible, ITokenTemplateEditorCompatible
    {
        public override bool Bold { get { return true; } }

        public override Color Color { get { return Color.Black; } }

        public override string Name { get { return "[UsDate]"; } }

        public override int Priority { get { return 4; } }

        public override string[] Tokens { get { return new string[] { "[UsDate:X)]" }; } }

        public override string[] Extensions { get { return new string[] { "Random" }; } }

        public string[] RegexTokens { get { return new string[] { @"(\[|{)UsDate([a-zA-Z0-9 ]+)*(\]|})" }; } }

        public string[] Token { get { return new string[] { "[UsDate]", "[UsDate:Random]" }; } }
                ...
                for (int k = 0; k < matchCollection.Count; k++)
                {
                    ...
                    if (extensions.Contains("Random", true))
                    {
                        ...
                        while (Content.Contains(matchCollection[k].Value))
                        {
                            ...
                            Content = Content.Insert(tokenIndex,
                                                     this.Random.Next(1, 13).ToString() + "/" + this.Random.Next(1, 31).ToString() + "/" +
                    ...
                    else
                    {
                        Content = Content.Replace(matchCollection[k].Value,
                                                  global::System.DateTime.Now.Month.ToString() + "/" + global::System.DateTime.Now.Day.ToString() + "/" + global::System.DateTime.Now.Year.ToString());
                    }
                }
            }
