...
{
    public partial class KeywordsEditorControl : UserControl
    {
        public KeywordsEditorControl()
        {
            InitializeComponent();
        }
        ...
        private void KeywordsEditorControlLoad(object sender, EventArgs e)
        {
            if (DesignMode)
            {
                return;
        ...
        public void UpdateControl()
        {
            ...
            contentTextBox.Lines = Core.Core.Instanse.Data[this.SelectedWorkSpace].Keywords[this.SelectedKeywords].Items;
        }
        ...
        protected void Save(object sender, EventArgs e)
        {
            ...
            (Core.Core.Instanse.Data[this.SelectedWorkSpace].Keywords[this.SelectedKeywords] as KeyWord).Items = contentTextBox.Lines;
        }
