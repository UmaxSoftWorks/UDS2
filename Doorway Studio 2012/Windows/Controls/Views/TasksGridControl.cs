...
{
    public partial class TasksGridControl : UserControl, IEventedControl, ITasksControl
    {
        public TasksGridControl()
        {
            InitializeComponent();
        }

        private void TasksControlLoad(object sender, EventArgs e)
        {
            if (DesignMode)
            {
                return;
