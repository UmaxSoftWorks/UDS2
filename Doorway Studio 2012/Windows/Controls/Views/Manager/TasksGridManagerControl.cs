...
{
    public partial class TasksGridManagerControl : UserControl, IEventedControl, ITasksControl
    {
        public TasksGridManagerControl()
        {
            InitializeComponent();
        }

        private void TasksGridManagerControlLoad(object sender, EventArgs e)
        {
            if (DesignMode)
            {
                return;
        ...
        protected virtual void InitializeImages()
        {
            ...
            filterToolStripSplitButton.Image = Resources.Resources.Update;
        ...
        {
            if (this.CanUpdate() && !DesignMode && this.Created && this.IsHandleCreated)
            {
