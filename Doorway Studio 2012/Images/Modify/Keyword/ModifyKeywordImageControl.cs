...
{
    public partial class ModifyKeywordImageControl : UserControl, IImageControl, IImageDataCompatible, IImageIDCompatible
    {
        public ModifyKeywordImageControl()
        {
            InitializeComponent();

            this.ImageMaker = new ModifyKeywordImageMaker();
        }
        ...
        public virtual IImageMaker ImageMaker
        {
            get
            {
                ...
                // Collect settings
                (this.imageMaker as ModifyKeywordImageMaker).Settings = this.CollectSettings();
        ...
        {
            switch (((this.imageMaker as ModifyKeywordImageMaker).Settings as ModifyKeywordImageSettings).Location)
            {
            ...
            locationTextBox.Text = ((this.imageMaker as ModifyKeywordImageMaker).Settings as ModifyKeywordImageSettings).LocationPath;

            this.ImageID = ((this.imageMaker as ModifyKeywordImageMaker).Settings as ModifyKeywordImageSettings).ImageID;

            switch (((this.imageMaker as ModifyKeywordImageMaker).Settings as ModifyKeywordImageSettings).Rename)
            {
                // Random
            ...
            renameTextBox.Text = ((this.imageMaker as ModifyKeywordImageMaker).Settings as ModifyKeywordImageSettings).RenameFile;

            fontSelectControl.Settings =
                ((this.imageMaker as ModifyKeywordImageMaker).Settings as ModifyKeywordImageSettings).Font;


            modificationsNoiseCheckBox.Checked =
                ((this.imageMaker as ModifyKeywordImageMaker).Settings as ModifyKeywordImageSettings).
                    ModificationsImageNoise;
        }

        private ModifyKeywordImageSettings CollectSettings()
        {
            ModifyKeywordImageSettings settings = new ModifyKeywordImageSettings();
        ...
        {
            return new ModifyKeywordImageControl();
        }
