...
{
    [Serializable, XmlRoot(ElementName = "CopyPasteRandomTextSettings")]
    public class CopyPasteRandomTextSettings : TextSettings
    {
        public CopyPasteRandomTextSettings()
        {
            this.TextPunctuationMarks = PunctuationMarksType.Consider;
        }

        public CopyPasteRandomTextSettings(ITextSettings Settings)
            : this()
        {
        ...
        public override string Name { get { return "CopyPasteRandomTextSettings"; } }
        ...
        {
            return new CopyPasteRandomTextSettings();
        }
    }
}
