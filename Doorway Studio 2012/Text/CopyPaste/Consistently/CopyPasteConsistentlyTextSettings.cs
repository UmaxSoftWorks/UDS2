...
{
    [Serializable, XmlRoot(ElementName = "CopyPasteConsistentlyTextSettings")]
    public class CopyPasteConsistentlyTextSettings : TextSettings
    {
        public CopyPasteConsistentlyTextSettings() {}

        public CopyPasteConsistentlyTextSettings(ITextSettings Settings)
            : this()
        {
        ...
        public override string Name { get { return "CopyPasteConsistentlyTextSettings"; } }

        /// <summary>
        /// Create new instance of CopyPasteConsistentlyTextSettings
        /// </summary>
        /// <returns>New instance of CopyPasteConsistentlyTextSettings</returns>
        public override object NewInstance()
        {
            return new CopyPasteConsistentlyTextSettings();
        }
    }
}
