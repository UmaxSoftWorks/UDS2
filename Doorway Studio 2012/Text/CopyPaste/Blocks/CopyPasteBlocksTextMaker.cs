...
{
    public class CopyPasteBlocksTextMaker : TextMaker
    {
        public CopyPasteBlocksTextMaker()
        {
            this.Index = 0;
            this.Settings = new CopyPasteBlocksTextSettings();
        }

        public override string Name
        {
            get { return "CopyPasteBlocksTextMaker"; }
        }
        ...
        {
            get { return "CopyPasteBlocksTextControl"; }
        }

        public override string GUIName
        {
            get { return "Copy/Paste: Blocks"; }
        }
