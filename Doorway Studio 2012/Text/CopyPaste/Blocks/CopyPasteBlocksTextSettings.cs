...
{
    [Serializable, XmlRoot(ElementName = "CopyPasteBlocksTextSettings")]
    public class CopyPasteBlocksTextSettings : TextSettings
    {
        public CopyPasteBlocksTextSettings() {}

        public CopyPasteBlocksTextSettings(ITextSettings Settings)
            : this()
        {
        ...
        public override string Name { get { return "CopyPasteBlocksTextSettings"; } }

        /// <summary>
        /// Create new instance of CopyPasteBlocksTextSettings
        /// </summary>
        /// <returns>New instance of CopyPasteBlocksTextSettings</returns>
        public override object NewInstance()
        {
            return new CopyPasteBlocksTextSettings();
        }
    }
}
