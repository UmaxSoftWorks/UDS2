...
{
    [Serializable, XmlRoot(ElementName = "CopyPasteLineByLineTextSettings")]
    public class CopyPasteLineByLineTextSettings : TextSettings
    {
        public CopyPasteLineByLineTextSettings() {}
        ...
        public override string Name { get { return "CopyPasteLineByLineTextSettings"; } }

        /// <summary>
        /// Create new instance of CopyPasteLineByLineTextSettings
        /// </summary>
        /// <returns>New instance of CopyPasteLineByLineTextSettings</returns>
        public override object NewInstance()
        {
            return new CopyPasteLineByLineTextSettings();
        }
    }
}
