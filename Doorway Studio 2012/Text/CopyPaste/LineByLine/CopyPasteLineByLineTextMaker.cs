...
{
    public class CopyPasteLineByLineTextMaker : TextMaker
    {
        public CopyPasteLineByLineTextMaker()
        {
            this.Index = 0;
            this.Settings = new CopyPasteLineByLineTextSettings();
        }

        public override string Name
        {
            get { return "CopyPasteLineByLineTextMaker"; }
        }
        ...
        {
            get { return "CopyPasteLineByLineTextControl"; }
        }

        public override string GUIName
        {
            get { return "Copy/Paste: Line by Line"; }
        }
