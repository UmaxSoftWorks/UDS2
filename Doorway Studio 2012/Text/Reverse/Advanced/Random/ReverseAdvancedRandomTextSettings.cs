...
{
    [Serializable, XmlRoot(ElementName = "ReverseAdvancedRandomTextSettings")]
    public class ReverseAdvancedRandomTextSettings : TextSettings
    {
        public ReverseAdvancedRandomTextSettings() {}

        public ReverseAdvancedRandomTextSettings(ITextSettings Settings)
            : this()
        {
        ...
        public override string Name { get { return "ReverseAdvancedRandomTextSettings"; } }

        /// <summary>
        /// Create new instance of ReverseAdvancedRandomTextSettings
        /// </summary>
        /// <returns>New instance of ReverseAdvancedRandomTextSettings</returns>
        public override object NewInstance()
        {
            return new ReverseAdvancedRandomTextSettings();
        }
    }
}
