...
{
    [Serializable, XmlRoot(ElementName = "ReverseSimpleRandomTextSettings")]
    public class ReverseSimpleRandomTextSettings : TextSettings
    {
        public ReverseSimpleRandomTextSettings() {}

        public ReverseSimpleRandomTextSettings(ITextSettings Settings)
            : this()
        {
        ...
        public override string Name { get { return "ReverseSimpleRandomTextSettings"; } }

        /// <summary>
        /// Create new instance of ReverseSimpleRandomTextSettings
        /// </summary>
        /// <returns>New instance of ReverseSimpleRandomTextSettings</returns>
        public override object NewInstance()
        {
            return new ReverseSimpleRandomTextSettings();
        }
    }
}
