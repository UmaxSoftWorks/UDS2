...
{
    [Serializable, XmlRoot(ElementName = "ReverseSimpleConsistentlyTextSettings")]
    public class ReverseSimpleConsistentlyTextSettings : TextSettings
    {
        public ReverseSimpleConsistentlyTextSettings() {}

        public ReverseSimpleConsistentlyTextSettings(ITextSettings Settings)
            : this()
        {
        ...
        public override string Name { get { return "ReverseSimpleConsistentlyTextSettings"; } }

        /// <summary>
        /// Create new instance of ReverseSimpleConsistentlyTextSettings
        /// </summary>
        /// <returns>New instance of ReverseSimpleConsistentlyTextSettings</returns>
        public override object NewInstance()
        {
            return new ReverseSimpleConsistentlyTextSettings();
        }
    }
}
