...
{
    [Serializable, XmlRoot(ElementName = "ReverseSimpleBlocksTextSettings")]
    public class ReverseSimpleBlocksTextSettings : TextSettings
    {
        public ReverseSimpleBlocksTextSettings() {}

        public ReverseSimpleBlocksTextSettings(ITextSettings Settings)
            : this()
        {
        ...
        public override string Name { get { return "ReverseSimpleBlocksTextSettings"; } }

        /// <summary>
        /// Create new instance of ReverseSimpleBlocksTextSettings
        /// </summary>
        /// <returns>New instance of ReverseSimpleBlocksTextSettings</returns>
        public override object NewInstance()
        {
            return new ReverseSimpleBlocksTextSettings();
        }
    }
}
