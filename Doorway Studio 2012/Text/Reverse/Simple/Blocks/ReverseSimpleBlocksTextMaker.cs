...
{
    public class ReverseSimpleBlocksTextMaker : TextMaker
    {
        public ReverseSimpleBlocksTextMaker()
        {
            this.Index = 0;
            this.Settings = new ReverseSimpleBlocksTextSettings();
        }

        public override string Name
        {
            get { return "ReverseSimpleBlocksTextMaker"; }
        }
        ...
        {
            get { return "ReverseSimpleBlocksTextControl"; }
        }

        public override string GUIName
        {
            get { return "Reverse: Blocks"; }
        }
        ...
        protected override void InitializeContent()
        {
            ...
            this.Fragments = this.Content.ToLower().Split(StringSplitType.Block, StringSplitOptions.RemoveEmptyEntries);
        }
