...
{
    [Serializable, XmlRoot(ElementName = "ReverseSimpleLineByLineTextSettings")]
    public class ReverseSimpleLineByLineTextSettings : TextSettings
    {
        public ReverseSimpleLineByLineTextSettings() {}

        public ReverseSimpleLineByLineTextSettings(ITextSettings Settings)
            : this()
        {
        ...
        public override string Name { get { return "ReverseSimpleLineByLineTextSettings"; } }

        /// <summary>
        /// Create new instance of ReverseSimpleLineByLineTextSettings
        /// </summary>
        /// <returns>New instance of ReverseSimpleLineByLineTextSettings</returns>
        public override object NewInstance()
        {
            return new ReverseSimpleLineByLineTextSettings();
        }
    }
}
