...
{
    public class ReverseSimpleLineByLineTextMaker : TextMaker
    {
        public ReverseSimpleLineByLineTextMaker()
        {
            this.Index = 0;
            this.Settings = new ReverseSimpleLineByLineTextSettings();
        }

        public override string Name
        {
            get { return "ReverseSimpleLineByLineTextMaker"; }
        }
        ...
        {
            get { return "ReverseSimpleLineByLineTextControl"; }
        }

        public override string GUIName
        {
            get { return "Reverse: Line By Line"; }
        }
        ...
        protected override void InitializeContent()
        {
            ...
            this.Fragments = this.Content.ToLower().Split(StringSplitType.Line, StringSplitOptions.RemoveEmptyEntries);
        }
