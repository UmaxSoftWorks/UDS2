...
{
    [Serializable, XmlRoot(ElementName = "ConceptualGraphCustomTextSettings")]
    public class ConceptualGraphCustomTextSettings : TextSettings
    {
        public ConceptualGraphCustomTextSettings()
        {
        ...
        public ConceptualGraphCustomTextSettings(ITextSettings Settings)
            : this()
        {
        ...
        /// <summary>
        /// Create new instance of ConceptualGraphCustomTextSettings
        /// </summary>
        /// <returns>New instance of ConceptualGraphCustomTextSettings</returns>
        public override object NewInstance()
        {
            return new ConceptualGraphCustomTextSettings();
        }
    }
}
