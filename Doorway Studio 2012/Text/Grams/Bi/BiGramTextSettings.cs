...
{
    [Serializable, XmlRoot(ElementName = "BiGramTextSettings")]
    public class BiGramTextSettings : TextSettings
    {
        public BiGramTextSettings()
        {
        ...
        public BiGramTextSettings(ITextSettings Settings)
            : this()
        {
        ...
        public override string Name { get { return "BiGramTextSettings"; } }
