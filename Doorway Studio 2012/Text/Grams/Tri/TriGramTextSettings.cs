...
{
    [Serializable, XmlRoot(ElementName = "TriGramTextSettings")]
    public class TriGramTextSettings : TextSettings
    {
        public TriGramTextSettings()
        {
        ...
        public TriGramTextSettings(ITextSettings Settings)
            : this()
        {
        ...
        {
            return new TriGramTextSettings();
        }
    }
}
